                                    ...
                                    <TableRow key={champData.championId}>
                                        <TableCell>
                                            <Box sx={{display: 'flex', flexDirection: 'row'}}>
                                                <img src={`/images/champions/icons/${champData.championId}_0.png`}
                                        ...
                                        <TableCell>
                                            <Box sx={{display: 'flex', flexDirection: 'row'}}>
                                                <WinRatePieChart wins={champData.totalWins}
                                                                 losses={champData.totalGames - champData.totalWins}
                                                                 height={25}/>
                                        ...
                                        <TableCell>
                                            <Typography
                                                align="center">{calculateChampionKDA(champData, 2)}:1</Typography>
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell>
                                            <Typography
                                                align="center">{toPerMinute(champData.averageDamageDealt, gameTime)}</Typography>
                                        </TableCell>
                                        <TableCell>
                                            <Typography
                                                align="center">{toPerMinute(champData.averageGoldEarned, gameTime)}</Typography>
                                        </TableCell>
                                        <TableCell>
