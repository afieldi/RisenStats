...
import {calculateCS, GameTypeToString, riotTimestampToGameTime, toSearchName} from "../../../../../Common/utils";
                ...
                <Box sx={{
                    ...
                    <Box sx={{pr: 2, display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
                        <Box sx={{display: "inline-flex"}}>
                            {/* Champion pfp */}
                            <Box sx={{pl: 1, pr: 1}}>
                                <img src={`/images/champions/icons/${mainPlayer.championId}_0.png`} height="50px"
                                     width="50px"></img>
                            </Box>
                            {/* pfp end */}
                            ...
                            <Box sx={{display: "flex", flexDirection: "column"}}>
                                <img src={`/images/summoner/${mainPlayer.summoner1Id}.png`} height="25px"
                                     width="25px"></img>
                                <img src={`/images/summoner/${mainPlayer.summoner2Id}.png`} height="25px"
                                     width="25px"></img>
                            </Box>
                            {/* Rune Choices */}
                            <Box sx={{display: "flex", flexDirection: "column", pl: .4}}>
                                <img src={`/images/runes/${mainPlayer.primaryRunes[0]}.png`} height="25px"
                                     width="25px"></img>
                                <img src={`/images/runes/${mainPlayer.secondaryStyle}.png`} height="25px"
                                     width="25px"></img>
                            </Box>
                            {/* Rune Choices End */}
                        </Box>
                        <Box>
                            <Typography variant="body2"
                                        align="center">{GameTypeToString(gameData.game.gameType, gameData.game.seasonId)}</Typography>
                        </Box>
                    </Box>
                    {/* Summoner Spells end */}
                        ...
                        <Box sx={{display: "flex", flexDirection: "column", width: '50%', pr: .5}}>
                            {
                                gameData.game.playersSummary.bluePlayers.map((player, i) => {
                                    return (
                                        <Box key={`blue-${gameData.game.gameId}-${i}`}
                                             sx={{display: "inline-flex", height: '1.2em', fontStretch: 'condensed'}}>
                                            ...
                                            <Box sx={{overflow: 'hidden', width: '75px'}}>
                                                <Link to={`/player/${encodeURIComponent(player.playerName)}`}>
                                                    <Typography variant="body2" align="left"
                                                                className="clickable-bg no-overflow player-names">
                                                        {player.playerName}
                                                    </Typography>
                                                </Link>
                                            </Box>
                        ...
                        <Box sx={{display: "flex", flexDirection: "column", width: '50%', pl: .5}}>
                            {
                                gameData.game.playersSummary.redPlayers.map((player, i) => {
                                    return (
                                        <Box key={`red-${gameData.game.gameId}-${i}`} sx={{
                                            display: "inline-flex",
                                            ...
                                            <Box sx={{overflow: 'hidden', width: '75px', textAlign: 'right'}}>
                                                <Link to={`/player/${encodeURIComponent(player.playerName)}`}>
                                                    <Typography variant="body2" align="right"
                                                                className="clickable-bg player-names">
                                                        {player.playerName}
                                                    </Typography>
                                                </Link>
                                            </Box>
