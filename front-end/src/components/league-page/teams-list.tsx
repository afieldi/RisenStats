...
import {
  ...
  buildTextBasedLeaderboardRowProps,
  LeaderboardRowProps,
  RowMainValue
...
export default function TeamListBox(props: TeamsListProps) {
  ...
  for (let team of props.teams) {
    ...
    leaderboardRows.push(buildTextBasedLeaderboardRowProps(team.abbreviation, `${team.win}W ${team.loss}L`, mainValue, theme, getRankColorByPercent));
  }
